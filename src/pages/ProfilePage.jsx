...
function ProfilePage() {
  ...
  return (
    <div className="profile-page">
      <h1 className="fade-in-down">My Profile</h1>
      ...
      <form onSubmit={handleSubmit} className="profile-form">
        <div className="profile-section avatar-section" data-section="avatar">
          <h2 className={visibleSections.has('avatar') ? 'fade-in-left' : ''}>Profile Picture</h2>
        ...
        <div className="profile-section" data-section="basic-info">
          <h2 className={visibleSections.has('basic-info') ? 'fade-in-left' : ''}>Basic Information</h2>
